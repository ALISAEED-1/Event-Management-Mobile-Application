...
class Splashscreenadmin2 extends StatefulWidget {
  const Splashscreenadmin2({super.key});
  @override
  State<Splashscreenadmin2> createState() => _Splashscreenadmin2State();
}

class _Splashscreenadmin2State extends State<Splashscreenadmin2> {
  PageController controller = PageController();
  int currentIndex = 0;

  List<OnboardingModeladmin> onboardinglist = [
    OnboardingModeladmin(
